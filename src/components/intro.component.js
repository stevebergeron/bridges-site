  ...
  render() {
    return (
      ...
      <div className="text-light">
        <h2>Welcome!</h2>
        <p className="text-justify">I have been interested in covered bridges for some time now,
        ...
        <p className="text-justify">The motorcycles changed over the years, but the mission remained the same.
        ...
        <p className="text-justify">As time marches on, things change. And these old bridges, the oldest of them
        ...
        <p className="text-justify">Other bridges have just plain fallen victim to time (and possibly neglect) and
      ...
      <div>
        <div className="row text-light">
          <div className="col">
            ...
            <p className="text-justify">Yes, in fact there are quite a few. What makes mine different is that rather than just
            ...
            <p className="text-justify">Each bridge's web page provides some basic stats about the bridge, but not every single
          ...
          <div className="col">
            ...
            <p className="text-justify">Much of the information I have shared on this site has come from multiple sources. 
            ...
            <p className="text-justify">Originally, this project started out as just a bunch of pictures that I put together 
